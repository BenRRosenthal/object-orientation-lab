...
class Vehicle {
  ...
  move(miles){
    ...
    console.log(`The vehicle has ${this.mileage} miles on it now`)
  }
}
...
//Code Here 
let myFirstMotorcycle = new Motorcycle(2, 'red', 12000, 'Ducati', true)
/*
...
class Boat extends Vehicle {
  ...
  performMaintenance(){
    this.isSeaworthy = true 
      console.log(`The ${this.color} ${this.type} ${this.name} is seaworthy now captian!`)
...
//Code Here
let myFirstBoat = new Boat(12, 'white', 230000, 'Knot Shore', 'Sailboat', false)
/*
